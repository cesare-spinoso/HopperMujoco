...
if __name__ == "__main__":
    ...
    try:
        ...
        raise ValueError("Could not load best_hyperparameters.py, this is required to do meta learning.")
    ...
    plot_rewards(learning_curve, logger.location, names=f"m_0", time_step=evaluation_freq)
